...
NOTE: Para actualizar desde Astra Trident que se instaló utilizando el operador de espacio de nombres (versiones 20.07 a 20.10), usa las instrucciones de actualización para tu versión instalada de Astra Trident.
