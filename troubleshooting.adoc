...
Cuando se utiliza nvme/tcp en entornos k8s con nombres de nodos largos, los pods no se pueden conectar al almacenamiento.

.Solución alternativa
Reduzca el nombre del nodo para que el nombre del subsistema tenga menos de 64 caracteres.
