...
Para obtener información detallada sobre los tipos de servicio y los niveles de servicio de Cloud Volumes Service en Google Cloud, consulte link:../trident-use/gcp.html["Obtenga más información sobre la compatibilidad de Astra Trident con CVS para GCP"].
